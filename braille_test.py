...
def test_text():
    ...
    assert text_to_text('hello') == 'hello'
    assert text_to_text('привет') == 'привет'
    assert text_to_text('123') == '123'
    assert text_to_text('123 абв abc .,!') == '123 абв abc .,!'

    assert text_to_text('133FCA') == '133FCA'
    assert text_to_text('133АБВ') == '133АБВ'
    assert text_to_text('123где') == '123где'
    assert text_to_text('123def') == '123def'

    assert text_to_text('13аВо3Fd,.;23fва') == '13аВо3Fd,.;23fва'
...
def test_images():
    ...
    assert text_to_text('hello') == 'hello'
    assert text_to_text('привет', 'russian') == 'привет'

    assert text_to_text('123 hour') == '123 hour'
    assert text_to_text('123 часа', 'russian') == '123 часа'
    assert text_to_text('123 часа hours', 'russian') == '123 часа hours'
    assert text_to_text('123 часа hours') == '123 часа hours'

    assert text_to_text('11.23 рубли', 'russian') == '11.23 рубли'
    assert text_to_text('"Иди ка ты" - сказал он мне', 'russian') == '"Иди ка ты" - сказал он мне'
    assert text_to_text('"Иди ка ты" - сказал он мне') == '"Иди ка ты" - сказал он мне'

    assert text_to_text('long story начинается') == 'long story начинается'
    assert text_to_text('long story начинается', 'russian') == 'long story начинается'
    assert text_to_text('long story привет begin начинается', 'russian') == 'long story привет begin начинается'

    assert text_to_text('hello привет hello привет') == 'hello привет hello привет'

    assert text_to_text('long') == 'long'
    assert text_to_text('long', 'russian') == 'лонг'

    assert text_to_text('колбаса tastefull колбаса') == 'колбаса tastefull колбаса'
    assert text_to_text('колбаса tastefull колбаса', 'russian') == 'колбаса tastefull колбаса'
    assert text_to_text('123 123 колбаса tastefull колбаса', 'russian') == '123 123 колбаса tastefull колбаса'
    assert text_to_text('123 123 колбаса tastefull full колбаса') == '123 123 колбаса tastefull full колбаса'

    assert text_to_text('123 wor 123 12.23 war') == '123 wor 123 12.23 war'
    assert text_to_text('123 вор 123 12.23 вар', 'russian') == '123 вор 123 12.23 вар'
...
def test_full():
    ...
    assert text_to_text(pangramm_ru, 'russian') == pangramm_ru
    assert text_to_text(pangramm_en) == pangramm_en

    assert text_to_text(pangramm_ru + pangramm_en) == pangramm_ru + pangramm_en
